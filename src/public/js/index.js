document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        showcaseContainer.innerHTML = '<p class="text-center text-red-500">Failed to load showcased properties.</p>';
    }
    ...
    try {
        ...
        reviewsContainer.innerHTML = '<p class="text-center text-red-500">Failed to load reviews.</p>';
    }
});